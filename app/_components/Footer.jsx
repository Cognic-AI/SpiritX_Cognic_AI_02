        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link href="/" className="inline-block mb-6">
              <Image src="/logo.svg" alt="Spirit11 Logo" width={150} height={60} />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/players" className="text-gray-400 hover:text-white">Players</Link>
              </li>
              <li>
                <Link href="/select-team" className="text-gray-400 hover:text-white">Select Team</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-gray-400 hover:text-white">How to Play</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <a href="mailto:support@spirit11.com" className="text-blue-400 hover:text-blue-300">
